...
echo === checks ===
python pyESS_app.py --selftest || (echo SELFTEST FAILED - not building & exit /b 1)
for /f "tokens=2" %%v in ('python pyESS_app.py --version') do set VER=%%v
...
python -m PyInstaller --noconfirm --clean pyESS.spec || exit /b 1
